...
namespace wasmcdt { namespace cdt {
   struct abigen_exception : public std::exception {
      virtual const char* what() const throw() {
         return "wasm.abigen fatal error";
      }
   };
   ...
   class abigen : public generation_utils {
      ...
      void add_action( const clang::CXXRecordDecl* decl ) {
         abi_action ret;
         auto action_name = decl->getWasmActionAttr()->getName();
      ...
      void add_table( const clang::CXXRecordDecl* decl ) {
         ...
         auto table_name = decl->getWasmTableAttr()->getName();
         if (!table_name.empty()) {
            try {
      ...
      void add_table( uint64_t name, const clang::CXXRecordDecl* decl ) {
         if (!(decl->isWasmTable() && abigen::is_wasm_contract(decl, get_contract_name())))
            return;
         abi_table t;
         t.type = decl->getNameAsString();
      ...
      std::string generate_json_comment() {
         std::stringstream ss;
         ss << "This file was generated with wasm-abigen.";
         ss << " DO NOT EDIT ";
         return ss.str(); 
      }
